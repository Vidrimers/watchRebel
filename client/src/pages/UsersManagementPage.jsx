            ...
            {users.map(user => (
              <div key={user.id} className={styles.userCard}>
                ...
                <div className={styles.userInfo}>
                  <div className={`${styles.userName} ${resolveDisplayNameWithTooltip(user.id, user.displayName).isNickname ? 'displayNameNickname' : ''}`} title={resolveDisplayNameWithTooltip(user.id, user.displayName).tooltip}>
