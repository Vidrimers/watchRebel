                  ...
                  {hasE2EEKey ? (
                      ...
                      <button
                        ...
                        onClick={async () => {
                          const confirmed = await showConfirm({
                            ...
                            message: 'Вы будете удалены из всех секретных групп. Все секретные чаты станут недоступны. Старые переписки восстановить невозможно. Это действие необратимо.',
                    ...
                    <>
                      ...
                      <button
                        ...
                        style={{ marginTop: '8px' }}
                      >
                        <Icon name="lock" size="small" /> Создать ключи E2EE
                      </button>
                    </>
                  )}
                </div>
